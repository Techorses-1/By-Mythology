// Updated Profile.jsx with Custom Confirmation Modal
...
const AddressCard = ({ address, onEdit, onDelete, onSetDefault, onConfirmDelete }) => {
    ...
    const handleDeleteClick = () => {
        onConfirmDelete(address.addressId);
    };
    ...
    const executeDeleteAddress = async () => {
        ...
        try {
            ...
            const response = await axios.delete(
                `${import.meta.env.VITE_API_URL}/profile/address/delete/${addressToDelete}`,
                {
                    headers: { Authorization: `Bearer ${token}` }
                }
            );
